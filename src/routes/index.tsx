  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Formation IA IZEMX" },
      {
        ...
        content: "Formation immersive IA pour entrepreneurs — Session août 2026.",
      },
        ...
        <div className="animate-fade-up">
          ...
          <div className="mt-8 glass rounded-2xl p-5">
            <div className="flex items-center gap-2 text-sm font-semibold text-white">
              <Calendar className="h-4 w-4 text-primary" /> Session août 2026
            </div>
            <div className="mt-3 grid gap-2 text-sm text-muted-foreground sm:grid-cols-3">
              <div>Samedi 15 août</div>
              <div>Samedi 22 août</div>
              <div>Samedi 29 août</div>
            </div>
        ...
        <div className="glass-strong rounded-3xl p-8 sm:p-12 glow-blue">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white sm:text-4xl">
              ...
              <span className="text-gradient">Session août</span>
            </h2>
